...
class EmpleadosController extends Controller
{
    ...
    public function getAll(){
        $empleados = DB::table('datos_personales')
             ...
             ->join('altas', 'datos_personales.num_emp', '=', 'altas.num_emp')
             ->join('funciones', 'datos_personales.num_emp', '=', 'funciones.num_emp')
             ...
             ->join('cargos', 'datos_personales.num_emp', '=', 'cargos.num_emp')
             ->join('ingresos_nominales', 'datos_personales.num_emp', '=', 'ingresos_nominales.num_emp')
             ...
             ->join('domicilios_personales', 'datos_personales.num_emp', '=', 'domicilios_personales.num_emp')
             ->join('cat1adscripciones', 'cambios_ads.baja_ads', '=', 'cat1adscripciones.id')
             ->join('cat1adscripciones as altaAds', 'cambios_ads.alta_ads', '=', 'altaAds.id')
             ->join('tipos_estados_republica', 'domicilios_personales.estado', '=', 'tipos_estados_republica.id')
             ->join('tipos_cargos', 'cargos.cargo', '=', 'tipos_cargos.id')
             ->join('tipos_ingresos', 'ingresos_nominales.tipo_ingreso', '=', 'tipos_ingresos.id')
             ->join('tipos_funciones', 'funciones.funcion', '=', 'tipos_funciones.id')
             ->join('tipos_bloques', 'cambios_bloques.bloque_alta', '=', 'tipos_bloques.id')
             ->join('grados', 'cambios_organicas.grado', '=', 'grados.id')
